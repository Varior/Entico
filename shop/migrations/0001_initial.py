    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('top_image', models.ImageField(blank=True, upload_to='products/%Y/%m/%d/', verbose_name='Зображення товару')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shop.Product', verbose_name='Товар')),
            ],
        ),
